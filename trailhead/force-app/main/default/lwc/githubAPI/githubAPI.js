...
const users = ['lukethacoder', 'KyleAMathews', 'DevonCrawford', 'wesbos', 'stolinski'];
  ...
  handleGetGithubData() {
    ...
    fetch(QUERY_URL + this.inputUsername)
      ...
      .then(json => {
        ...
        } else if (json.documentation_url === 'https://developer.github.com/v3/#rate-limiting') {
          this.error = 'Oops, max API limit reached. Authenticated users get more requests';
        } else {
          this.userData = json;
